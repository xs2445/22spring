...
from yolo2onnx import DarkNetParser, get_h_and_w
...
def main():
    ...
    parser.add_argument(
        '-cfg', '--config_file', type=str, required=True,
        help=('Specify cfg file path'))
    parser.add_argument(
        '-o', '--onnx_file', type=str, required=True,
        help=('Specify onnx file path'))
    parser.add_argument(
