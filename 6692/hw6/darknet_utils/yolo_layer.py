"""
This file contains the PyTorch YOLO layer implementation. The YOLO layer converts 
feature maps to detections, class predictions, and confidence thresholds. 
